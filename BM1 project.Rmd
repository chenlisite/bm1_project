...
#we throw out influtential values and creat a new data called data_based2
...
#By compared with coefficients with summary(), we can see the estimated coefficients fall into confident interval.

```

log_los  =  4.049 + 0.150 is30dayreadmit - 0.001 cindexmild + 0.256 cindexmoderate+                            0.267 cindexsevere + 0.067evisit +  0.009 age -0.021 insurance_type1 -
            0.119insurance_type2 - 0.007 bp_systolic + 0.004heart_rate +  0.013respiration_rate
